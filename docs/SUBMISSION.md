...
`docs/HANDOVER.md` is the full checklist: provisioning order, the credentials each identity needs, preflight, the traps, and what we would do before running this for real.
